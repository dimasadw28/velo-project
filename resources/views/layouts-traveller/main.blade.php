...
<body>
        ...
        <div class="mr-4">
          <form class="form-inline" action="{{ route('search') }}">
            <div class="form-sm my-0">
              <input class="form-control form-control-sm mr-sm-2 mb-0" type="text" name="search" placeholder="Search" aria-label="Search" autocomplete="off">
            </div>
  ...
  <footer class="page-footer font-small py-3 mt-5">
    <div class="footer-copyright text-center text-white text-md-left ml-3">
      ...
      <a oncontextmenu="return false;" onclick="myFunction()" class="fa fa-adjust text-white textfooter1"> Dark Mode</a>
    </div>
